...
export default function AboutUs({containerClass, title, body, ctaText, ctaHref}){
                ...
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="section-title ms-lg-5">
                            <h4 className="title mb-3">{title ? title : <>Pharmacy Job Platform. <br/> Find the right opportunity you deserve.</>}</h4>
                            {body ? body : <>
                            ...
                            <div className="mt-4">
                                <Link href={ctaHref ? ctaHref : "/aboutus"} target={ctaHref ? "_blank" : undefined} className="btn btn-primary">{ctaText ? ctaText : "About Us"} <i className="mdi mdi-arrow-right align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
